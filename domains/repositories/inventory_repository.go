...
type InventoryQueryRepositoryInterface interface {
	...
	FindByCategory(ctx context.Context, category enums.InventoryCategory) ([]*entities.Inventory, error)
	FindByDistributor(ctx context.Context, distributorID uint) ([]*entities.Inventory, error)
	FindAll(ctx context.Context) ([]*entities.Inventory, error)
	FindLowStock(ctx context.Context) ([]*entities.Inventory, error)
}
